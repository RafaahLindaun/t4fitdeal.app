...
function dayPillLabel(value: string) {
  ...
  return label.slice(0, 3).replace(/^./, (char) => char.toUpperCase());
}
...
export default function Aulas() {
  ...
  const groups = useMemo(() => {
    ...
    return selectedItems.length ? [[selectedDate, selectedItems] as [string, ClassAgendaItem[]]] : [];
    ...
    <div className="classes-screen">
      ...
      <main className="classes-shell">
        ...
        <div className="classes-scroll">
          ...
          <div className="classes-type-filters" data-tab-swipe-ignore aria-label="Filtrar por modalidade">
          ...
          {agendaQuery.isLoading ? (
            ...
            <div className="classes-groups">
              {groups.map(([date, dayItems]) => (
                <section className="classes-day-group" key={date}>
                  <header>
