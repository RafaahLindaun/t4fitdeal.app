    ...
    <div className="cardio-screen">
      ...
      <main className="cardio-page">
        <PageHeader className="cardio-topbar" ariaLabel="Cabeçalho Cardio"
          ...
          right={<button type="button" className="cardio-top-button cardio-history-button" onClick={() => setHistoryOpen(true)} aria-label="Abrir histórico de cardio"><CardioHistoryIcon /><span>Histórico</span></button>}
        />
