  ...
  return (
    <section className="diet-meals-section">
      ...
      {meals.length ? (
        ...
        <EmptyState className="diet-empty-meals" icon={<DietCameraIcon size={28} />} title="Nenhuma refeição registrada" description="Fotografe seu prato ou rótulo para começar o diário de hoje." />
      )}
    </section>
  );
}
