          ...
          {!loadingDashboard && view === "main" ? (
            <>
              ...
              <section className="profile-stats-grid" aria-label="Resumo do perfil">
                <article><div className="profile-stat-value"><span><ProfileIcon name="dumbbell" /></span><strong>{treinoStatus.isLoading ? "…" : (treinoStatus.data?.totalCompleted ?? 0)}</strong></div><p>Treinos</p></article>
              ...
              <section className="profile-menu-section profile-reservations-section">
                <div className="profile-section-heading"><div><small>LOJA ACCQUA</small><h3>Minhas peças reservadas</h3></div><strong>{reservationsQuery.data?.length ?? 0}</strong></div>
