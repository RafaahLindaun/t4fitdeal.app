...
export function DietInfoIcon({ size = 22, className }: IconProps) {
  return <svg {...base(size, className)}><circle cx="12" cy="12" r="8.4" /><path d="M12 10.7v5.2" /><path d="M12 7.4h.01" /></svg>;
}
export function DietUndoIcon({ size = 22, className }: IconProps) {
  return <svg {...base(size, className)}><path d="M8.2 8H4.8V4.6" /><path d="M5.1 8.1A8 8 0 1 1 4.6 15" /></svg>;
}
export function DietDumbbellIcon({ size = 22, className }: IconProps) {
  return <svg {...base(size, className)}><path d="M6.3 8.2v7.6M3.8 9.6v4.8M17.7 8.2v7.6M20.2 9.6v4.8M6.3 12h11.4" /></svg>;
}

export function DietClockIcon({ size = 22, className }: IconProps) {
  return <svg {...base(size, className)}><circle cx="12" cy="12" r="8.5" /><path d="M12 7.5v5l3.2 1.9" /></svg>;
}
export function DietHeartIcon({ size = 22, className }: IconProps) {
  return <svg {...base(size, className)}><path d="M20 8.8c0 5-8 10.2-8 10.2S4 13.8 4 8.8A4.3 4.3 0 0 1 12 6.6a4.3 4.3 0 0 1 8 2.2Z" /></svg>;
}
