...
export function MenuCheckinIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg className={className} {...utilityProps(size)}>
      <path d="M5 5.6h14v12.8H5z" />
      <path d="M8 3.6v4M16 3.6v4M5 9.4h14" />
      <path d="m8.4 14 2.05 2.05 4.45-4.45" />
    </svg>
  );
}
...
export function MenuShieldIcon({ size = 30, className = "" }: IconProps) {
  return (
    <svg className={className} {...utilityProps(size, "0 0 24 24", 1.72)}>
