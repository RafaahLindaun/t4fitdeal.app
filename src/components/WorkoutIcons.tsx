...
export function WorkoutCalendarIcon({
  ...
  return (
    <svg className={className} {...base(size, "0 0 24 24", 1.65)}>
      <rect x="3.2" y="5.3" width="17.6" height="15.2" rx="2" />
      <path d="M7.2 3v4.2M16.8 3v4.2M3.2 9.7h17.6" />
      <path d="M7.4 13h.01M12 13h.01M16.6 13h.01M7.4 16.7h.01M12 16.7h.01M16.6 16.7h.01" />
    </svg>
  );
}
...
export function WorkoutPlayIcon({
  size = 27,
  className = "",
}: WorkoutIconProps) {
  return (
