...
export function BuilderShieldIcon({ size = 22, className = "" }: IconProps) {
  return (
    <svg className={className} {...base(size)}>
      <path d="M12 3.2 5.7 5.8v4.6c0 4.25 2.65 7.4 6.3 9.3 3.65-1.9 6.3-5.05 6.3-9.3V5.8L12 3.2Z" />
      <path d="m8.8 11.7 2.05 2.05 4.4-4.5" />
    </svg>
  );
}

export function BuilderLockIcon({ size = 22, className = "" }: IconProps) {
  return (
    <svg className={className} {...base(size)}>
      <rect x="5.3" y="10" width="13.4" height="10" rx="2.2" />
...
export function BuilderRefreshIcon({ size = 21, className = "" }: IconProps) {
  return (
    <svg className={className} {...base(size)}>
      <path d="M19.2 8.6A7.7 7.7 0 1 0 19 16" />
      <path d="M19.2 4.8v3.8h-3.8" />
    </svg>
  );
}
