...
export default function Profile() {
  ...
  const reload = async () => {
    ...
    setDashboard(next);
    cacheFeedbackPreferences(user.id, { soundEnabled: next.preferences.soundEnabled, vibrationEnabled: next.preferences.vibrationEnabled });
    setPersonalForm({
              ...
              <section className="profile-identity-card">
                ...
                <div className="profile-identity-copy">
                  ...
                  <div className="profile-identity-tags">
                    <span className="is-status"><i />{profileStatusLabel}</span>
