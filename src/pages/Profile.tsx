  ...
  return (
    <div className="accqua-profile-screen">
      ...
      <main className="accqua-profile-shell">
        <div
          className="accqua-profile-top"
          style={
            {
              "--profile-top-height": `${view === "main" ? Math.max(0, 121 - headerProgress * 121) : 121}px`,
              "--profile-top-opacity": view === "main" ? 1 - headerProgress : 1,
              "--profile-top-shift": `${view === "main" ? -10 * headerProgress : 0}px`,
            } as CSSProperties
          }
        >
