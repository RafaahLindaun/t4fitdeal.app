  ...
  return (
    <div className="accqua-profile-screen">
      ...
      <main className="accqua-profile-shell">
        <div className={`accqua-profile-top ${profileScrolled ? "is-scrolled" : ""}`}>
        ...
        <section
          className="accqua-profile-content"
          ref={contentRef}
          onScroll={(event) => {
            if (view !== "main") return;
            const scrollTop = event.currentTarget.scrollTop;
            setProfileScrolled((current) =>
              current ? scrollTop > 8 : scrollTop > 36,
            );
          }}
        >
          {loadingDashboard ? (
