...
export default function Profile() {
  ...
  const profileStatusLabel = isStaffProfile
    ...
    : active
      ...
      : "Conta autorizada";
  const statsAreEmpty =
    dashboard.totalWorkoutSessions === 0 &&
  ...
  return (
    <div className="accqua-profile-screen">
      ...
      <main className="accqua-profile-shell">
        <aside className="accqua-profile-desktop-sidebar" aria-label="Navegação do perfil">
          <div className="profile-sidebar-brand"><AccquaLogo compact /></div>
          <nav className="profile-sidebar-nav">
            <button type="button" onClick={() => void handleBottomNavigation("Início")}>
              <span><ProfileIcon name="home" size={22} /></span>
              <strong>Início</strong>
            </button>
            <button type="button" onClick={() => void handleBottomNavigation("Treino")}>
              <span><ProfileIcon name="dumbbell" size={22} /></span>
              <strong>Treino</strong>
            </button>
            <button type="button" onClick={() => void handleBottomNavigation("Aulas")}>
              <span><ProfileIcon name="calendar" size={22} /></span>
              <strong>Aulas</strong>
            </button>
            <button type="button" className="is-active" aria-current="page" onClick={() => void handleBottomNavigation("Perfil")}>
              <span><ProfileIcon name="user" size={22} /></span>
              <strong>Perfil</strong>
            </button>
          </nav>
          <div className="profile-sidebar-account">
            <div className="profile-sidebar-avatar">
              {details.avatarUrl ? <img src={details.avatarUrl} alt="" /> : <strong>{initials(profileDisplayName)}</strong>}
            </div>
            <div>
        ...
        <div className="accqua-profile-top">
          <header className="accqua-profile-header">
            {view === "main" ? (
              <span className="profile-header-space" aria-hidden="true" />
            ) : (
            ...
            <>
              <section className="profile-identity-card">
                <div className="profile-avatar-wrap">
                  ...
                  <button className="profile-avatar-action" type="button" onClick={chooseAvatar} aria-label="Alterar foto de perfil" disabled={uploadingAvatar}>
              ...
              <section className="profile-stats-grid" aria-label="Resumo do perfil">
                <article><div className="profile-stat-value"><span><ProfileIcon name="dumbbell" /></span><strong>{dashboard.totalWorkoutSessions}</strong></div><p>Treinos</p></article>
                <article><div className="profile-stat-value"><span><ProfileIcon name="cardio" /></span><strong>{dashboard.totalCardioMinutes}</strong></div><p>Min. cardio</p></article>
                <article><div className="profile-stat-value"><span><ProfileIcon name="calendar" /></span><strong>{dashboard.totalClasses}</strong></div><p>Aulas</p></article>
                <article><div className="profile-stat-value"><span><ProfileIcon name="trophy" /></span><strong>{dashboard.rankingPoints}</strong></div><p>Pontos</p></article>
              </section>
