          ...
          {!loadingDashboard && view === "main" ? (
            <>
              ...
              <section className="profile-stats-grid" aria-label="Resumo do perfil">
                <article><div className="profile-stat-value"><span><ProfileIcon name="dumbbell" /></span><strong>{treinoStatus.isLoading ? "…" : treinoStatus.isError ? "—" : (treinoStatus.data?.totalCompleted ?? 0)}</strong></div><p>Treinos</p></article>
