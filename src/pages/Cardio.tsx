...
export default function Cardio() {
  ...
  return (
    <div className="cardio-screen">
      ...
      <main
        className={`cardio-page ${focusMode ? "is-focus" : ""} is-${status}`}
      >
        ...
        <section className="cardio-workspace">
          <section className="cardio-hero-stage">
            ...
            <button
              type="button"
              className="cardio-hero-quick-settings"
              onClick={() => setSettingsOpen(true)}
              aria-label="Abrir configurações do cardio"
              title={timingLabels[timing]}
            >
              <CardioSettingsIcon />
            </button>
          ...
          <section className="cardio-live-stage">
            ...
            <div
              className={`cardio-timer-ring ${status}`}
              style={
                {
