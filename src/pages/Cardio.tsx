...
import treadmillImage from "../assets/cardio/treadmill.webp";
import bikeImage from "../assets/cardio/spinning.webp";
import ellipticalImage from "../assets/cardio/elliptical.webp";
import stairsImage from "../assets/cardio/stairs.webp";
import rowingImage from "../assets/cardio/rowing.webp";
import walkImage from "../assets/cardio/walk.webp";
import swimImage from "../assets/cardio/swim.webp";
import {
  finishCardioSession,
  loadCardioDashboard,
  saveCardioSnapshot,
    ...
    <div className="cardio-screen">
      ...
      >
        ...
        <section className="cardio-main">
          ...
          <section className="cardio-duration-card">
            <header>
              <div>
                <CardioClockIcon />
                <span>
                  <strong>Tempo planejado</strong>
                  <small>Ajuste antes de iniciar</small>
                </span>
              </div>
              <b>{String(targetMinutes).padStart(2, "0")}:00</b>
            </header>

            <div className="cardio-duration-controls">
              <button
                type="button"
                onClick={() =>
