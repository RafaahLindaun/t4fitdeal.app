  ...
  return (
    <div className="cardio-screen">
      ...
      >
        ...
        <section className="cardio-main">
          <header className="cardio-title-row">
            <div>
              <span>
          ...
          <section className="cardio-live-panel">
            <button
              ...
              onClick={() =>
                setMetricInfo({
                  ...
                  value: `${calories} kcal`,
                  helper:
                    "Estimativa baseada na modalidade, intensidade e tempo realizado nesta sessão.",
                })
              }
            ...
            <button
              ...
              onClick={() =>
                setMetricInfo({
                  title: metricTitle,
                  value: `${metricValue} ${metricUnit}`,
                  helper:
                    activity === "treadmill" ||
                    activity === "walk" ||
                    activity === "elliptical"
                      ? "Pace calculado pela velocidade configurada na máquina."
                      : "Métrica de ritmo calculada conforme a modalidade escolhida.",
                })
              }
              aria-label="Ver detalhes de ritmo"
            >
              <CardioPulseIcon />
          ...
          <section className="cardio-mode-picker">
            <header>
              <div>
                ...
                <span>Escolha antes de iniciar</span>
              </div>
      ...
      {metricInfo ? (
        <div
          className="cardio-metric-popover"
          role="dialog"
          aria-modal="true"
          aria-label={metricInfo.title}
        >
          <button
            type="button"
            className="cardio-metric-popover-backdrop"
            onClick={() => setMetricInfo(null)}
            aria-label="Fechar detalhe"
          />

          <section className="cardio-metric-popover-card">
            <span>{metricInfo.title}</span>
            <strong>{metricInfo.value}</strong>
            <p>{metricInfo.helper}</p>
            <button type="button" onClick={() => setMetricInfo(null)}>
              Entendi
            </button>
          </section>
        </div>
