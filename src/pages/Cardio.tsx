  ...
  useEffect(() => {
    const syncScale = () => {
      ...
      document.documentElement.style.setProperty(
        "--cardio-viewport-height",
        `${Math.round(height)}px`,
      );
      document.documentElement.style.setProperty(
        "--cardio-artboard-scale",
        String(Math.max(0.56, scale)),
      );
    };
  ...
  return (
    <div className="cardio-screen">
      ...
      <main className="cardio-artboard">
        ...
        <section className="cardio-dashboard">
          ...
          <section className="cardio-hero">
            ...
            <div className="cardio-hero-visual">
              {activity === "treadmill" && !heroImageFailed ? (
                <img
                  src={treadmillRunnerImage}
                  alt="Pessoa correndo na esteira"
                  onError={() => setHeroImageFailed(true)}
                />
              ) : (
                <div className="cardio-mode-illustration">
                  <CurrentIcon size={122} />
