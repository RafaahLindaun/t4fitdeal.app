...
export default function TestMenu() {
  ...
  const openArea = async (title: string) => {
    ...
    if (title === "Loja") {
      setMessage("Loja será a próxima tela que vamos construir.");
      return;
    }
  };
    ...
    <div className="accqua-menu-screen">
      ...
      <main className="accqua-menu-shell">
        ...
        >
          ...
          <motion.section className="accqua-workout-hero" variants={itemVariants} aria-label="Treino de hoje">
            <div className="accqua-workout-hero-pattern" aria-hidden="true" />
            <div className="accqua-workout-hero-kicker">
              <span>TREINO DE HOJE</span>
              {workout?.completedToday ? <i>CONCLUÍDO</i> : null}
            </div>

            {homeQuery.isLoading ? (
              <div className="accqua-workout-hero-loading">
                <span /><span /><span />
              </div>
              ...
              <>
                ...
                {workout.completedSets > 0 ? (
                  <div className="accqua-workout-hero-progress">
                    <div>
                      <span>{formatProgress(workout.completedExercises, workout.exerciseCount)} exercícios concluídos hoje</span>
                ...
                >
                  <span>{heroLabel}</span>
                  {isDesktop ? <MenuPhoneIcon size={19} /> : <MenuArrowIcon size={20} />}
                </motion.button>
              </>
            ) : (
