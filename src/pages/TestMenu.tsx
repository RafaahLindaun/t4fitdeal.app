  ...
  return (
    <div className="accqua-menu-screen">
      ...
      <main className="accqua-menu-shell">
        ...
        {isTeam ? (
          <section className="accqua-staff-menu-card" aria-label="Área da equipe">
            <div className="accqua-staff-menu-heading">
              <span className="accqua-staff-menu-icon">
                <MenuDumbbellIcon size={30} />
              </span>
              <div>
                <small>
                ...
                <p>Monte treinos ou libere a entrada no aplicativo.</p>
              </div>
            </div>

            <div className="accqua-staff-menu-actions">
              <button
                type="button"
                onClick={() => navigate("/montar-treino")}
              >
                <MenuDumbbellIcon size={23} />
                <span>
                  <strong>Montar treino</strong>
                  <small>Buscar aluno e publicar</small>
                </span>
                <MenuArrowIcon size={19} />
              </button>

              <button
                type="button"
                onClick={() => navigate("/autorizar-acesso")}
              >
                <MenuShieldIcon size={23} />
                <span>
                  <strong>Autorizar entrada</strong>
                  <small>Liberar cadastro pendente</small>
                </span>
                <MenuArrowIcon size={19} />
              </button>
            </div>
