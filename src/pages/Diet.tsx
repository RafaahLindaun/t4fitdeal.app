    ...
    <div className="diet-screen">
      ...
      <main className="diet-shell">
        <PageHeader className="diet-topbar" ariaLabel="Cabeçalho Minha dieta"
          left={<div className="diet-topbar-side is-left"><button type="button" className="diet-round-button" aria-label="Voltar para início" onClick={() => navigate("/menu-teste")}><DietBackIcon /></button><span className="diet-topbar-spacer"/><span className="diet-topbar-spacer"/></div>}
          center={<div className="diet-title"><span>ACCQUA NUTRIÇÃO</span><h1>Minha dieta</h1></div>}
