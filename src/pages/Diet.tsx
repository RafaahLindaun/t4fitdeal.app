    ...
    <div className="diet-screen">
      ...
      <main className="diet-shell">
        <header className="diet-topbar">
          <div className="diet-topbar-side is-left">
          ...
          <section className="diet-overview">
            ...
            <div className="diet-burn-detail">
              ...
              <div className="diet-burn-pills" aria-label="Detalhamento do gasto calórico de hoje">
                <span><DietFireIcon size={16} /> Cardio: <b>{data.burn.cardioCalories} kcal</b></span>
                <span><DietDumbbellIcon size={16} /> Musculação: <b>{data.burn.strengthCalories} kcal</b></span>
              </div>
