    ...
    <div className="diet-screen">
      ...
      <main className="diet-shell">
        <header className="diet-topbar">
          <div className="diet-topbar-side is-left" aria-hidden="false">
            ...
            <span className="diet-topbar-spacer" aria-hidden="true" />
            <span className="diet-topbar-spacer" aria-hidden="true" />
          </div>
          <div className="diet-title"><span>ACCQUA NUTRIÇÃO</span><h1>Minha dieta</h1></div>
          <div className="diet-topbar-side is-right">
            <button type="button" className="diet-round-button" aria-label="Informações sobre Minha dieta" onClick={() => setInfoOpen(true)}><DietInfoIcon /></button>
            {profileComplete ? (
              <button type="button" className="diet-round-button" aria-label="Abrir cronograma sugerido de refeições" onClick={() => setScheduleOpen(true)}><DietClockIcon /></button>
            ) : <span className="diet-topbar-spacer" aria-hidden="true" />}
        ...
        <div className="diet-scroll-content">
          <section className="diet-overview">
            ...
            <CalorieRing consumed={data.consumedCalories} target={calorieTarget} burned={safeKcal(data.burn.calories)} />
        ...
        <BottomNavigation onSelect={handleNavigation} disabledLabels={["Aulas"]} />
      </main>
