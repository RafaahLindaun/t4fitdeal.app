...
import CardioHistoryDialog from "../components/cardio/CardioHistoryDialog";
import {
  DietBackIcon,
  DietCameraIcon,
  DietClockIcon,
...
export default function Diet() {
  ...
  const [cardioHistoryOpen, setCardioHistoryOpen] = useState(false);
  ...
  return (
    <div className="diet-screen">
        ...
        <div className="diet-scroll-content">
          <section className="diet-overview">
            ...
            <div className="diet-burn-detail">
              ...
              <button type="button" className="diet-cardio-history-link" onClick={() => setCardioHistoryOpen(true)}>Histórico de cardio</button>
            </div>
          </section>
      ...
      <CardioHistoryDialog open={cardioHistoryOpen} onOpenChange={setCardioHistoryOpen} userId={user.id} />
      <HealthNudgeDialog
