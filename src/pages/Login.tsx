...
export default function Login() {
  ...
  useEffect(() => {
    ...
    const syncViewport = () => {
      ...
      const keyboard = height < Math.min(window.screen.height * 0.72, 560);
      ...
      <main className="login-artboard" aria-label="Login Accqua Sports">
        ...
        <section className="concept-access-banner">
          ...
          <div>
            ...
            <span>Seu acesso é liberado de acordo com sua<br />matrícula ativa na academia.</span>
          </div>
        </section>
        ...
        <form className="concept-login-form" onSubmit={handleLogin}>
          ...
          <label className="concept-login-field">
            ...
            />
            <button className="concept-forgot-inline" type="button" onClick={handleReset}>
              Esqueci?
            </button>
            <button
