      ...
      <div className="workout-screen">
        ...
        <main className="workout-empty-shell">
          ...
          <section className="workout-empty-card">
            ...
            <h1>Seu treino estará aqui em breve</h1>
            <p>
              Assim que o professor montar e publicar seu plano,
              os exercícios, séries, repetições, descansos e
              orientações aparecerão automaticamente nesta tela.
            </p>
