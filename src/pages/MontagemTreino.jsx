...
function EmphasisIconImage({ type, size = 118 }) {

  const fallback = EMPHASIS_ICON_SRC.gluteo;

  const src = EMPHASIS_ICON_SRC[type] || fallback;
              ...
              return (
                ...
                >
                  ...
                  <div style={S.bigIconArea}>
                    ...
                    <EmphasisIconImage type={item.icon || item.id} size={118} />
        ...
        <section style={S.selectedContent}>
          ...
          <div style={S.selectedTop}>
            ...
            <div style={{ ...S.selectedIcon, background: selected.soft }}>
              ...
              <EmphasisIconImage type={selected.icon || selected.id} size={82} />

            </div>

            <div style={{ minWidth: 0 }}>

              <div style={S.selectedKicker}>{selected.title}</div>
