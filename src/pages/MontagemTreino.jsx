      ...
      <div style={S.wrap}>
        ...
        <section style={S.topBar}>
          ...
          <div style={S.topText}>
            ...
            <p style={S.sub}>Passe para o lado, escolha uma ênfase e toque nela novamente para abrir.</p>
        ...
        <section style={S.railSection}>
          ...
          <div style={S.railHead}>
            ...
            <div>
              ...
              <div style={S.railTitle}>Ênfases</div>

              <div style={S.railSub}>Cards grandes, livres na página e com visual mais dinâmico.</div>
              ...
              return (
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: active
                      ...
                      ? `0 32px 90px ${item.soft}, 0 16px 45px rgba(15,23,42,.12)`

                      : "0 18px 44px rgba(15,23,42,.08)",

                    transform: active

                      ? "perspective(1100px) rotateY(0deg) scale(1)"

                      : index % 2 === 0

                        ? "perspective(1100px) rotateY(-7deg) scale(.955)"
                ...
                >
                  ...
                  <div style={S.bigCardBottom}>
                    ...
                    <div style={S.cardHint}>{active ? "Toque novamente para abrir" : "Selecionar"}</div>
