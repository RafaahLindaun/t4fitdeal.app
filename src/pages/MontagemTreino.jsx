...
const STYLE_FILTERS = {
  ...
  superior: { label: "Superior", keys: ["peito", "costas", "ombro", "biceps", "triceps"] },

  inferior: { label: "Inferior", keys: ["quadriceps", "posterior", "gluteo", "panturrilha"] },

  seguro: { label: "Seguro", keys: ["core", "costas", "posterior", "gluteo"] },

  completo: { label: "Completo", keys: ["peito", "costas", "quadriceps", "posterior", "gluteo", "ombro", "core"] },
