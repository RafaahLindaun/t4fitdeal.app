...
const GIF_NAME_MAP = {
  ...
  "Hip thrust": "elevacao-pelvica-com-pausa",

  "Hip thrust (barra)": "elevacao-pelvica-com-pausa",

  "Hip thrust (máquina)": "elevacao-pelvica-com-pausa",

  "Elevação pélvica com pausa": "elevacao-pelvica-com-pausa",
  ...
  "Agachamento sumô leve": "agachamento-sumo",

  "Agachamento livre": "agachamento-livre",

  "Agachamento goblet": "agachamento-goblet",

  "Agachamento goblet leve": "agachamento-goblet",

  "Agachamento": "agachamento",

  "Cadeira abdutora": "cadeira-abdutora-apoio-de-quadril",

  "Cadeira abdutora (apoio de quadril)": "cadeira-abdutora-apoio-de-quadril",

  "Abdução na máquina": "cadeira-abdutora-apoio-de-quadril",
  ...
  "Prancha": "core-prancha",

  "Prancha lateral": "prancha-lateral",

  "Hiperextensão lombar leve": "hiperextensao-lombar",

  "Hiperextensão": "hiperextensao-lombar",

  "Hiperextensão com foco glúteo/posterior": "hiperextensao-lombar",

  "Remada baixa": "remada-baixa",

  "Remada baixa no cabo": "remada-baixa",

  "Remada máquina": "remada-maquina",

  "Remada máquina (hammer)": "remada-maquina",

  "Remada curvada": "remada-curvada",

  "Remada curvada com barra": "remada-curvada",

  "Alongamento de posterior": "alongamento-posterior",

  "Cardio moderado": "cardio-moderado",
  ...
  "Supino inclinado com halteres": "supino-inclinado",
  ...
  "Desenvolvimento com halteres": "desenvolvimento",

  "Face pull": "face-pull",

  "Face pull (escápulas/postura)": "face-pull",

};

function gifBaseNameForExercise(name) {

  return GIF_NAME_MAP[name] || slugify(name);

}

function gifSourcesForExercise(name) {

  const base = gifBaseNameForExercise(name);
...
function getApplyWindow(scope) {
  ...
  const safeScope = ["hoje", "semana", "mes"].includes(scope) ? scope : "hoje";

  const start = new Date();

  start.setHours(12, 0, 0, 0);

  const days = safeScope === "semana" ? 7 : safeScope === "mes" ? 30 : 1;
  ...
  return {
    ...
    label: safeScope === "hoje" ? "Hoje" : safeScope === "semana" ? "1 semana" : "1 mês",
...
function makeExerciseFromCatalog(name, groupKey) {
  ...
  return {
    ...
    gifSources: gifSourcesForExercise(name),
...
export default function MontagemTreino() {
  ...
  const payload = useMemo(() => {
    ...
    return {
      ...
      duration: applyWindow.scope,

      selectedScope: applyWindow.scope,

      startsOn: applyWindow.startsOn,

      endsOn: applyWindow.endsOn,

      durationDays: applyWindow.days,
  ...
  }, [selected, applyWindow, targetDays, profile, subscription, isPaid, planKey, exercises]);
  ...
  async function saveMontage(customScope = scope) {
    ...
    const finalPayload = {
      ...
      duration: nextApply.scope,

      selectedScope: nextApply.scope,

      apply: nextApply,

      startsOn: nextApply.startsOn,

      endsOn: nextApply.endsOn,

      durationDays: nextApply.days,
    ...
    try {
      ...
      const insertRow = {
        ...
        selected_scope: finalPayload.apply.scope,

        starts_on: finalPayload.apply.startsOn,

        ends_on: finalPayload.apply.endsOn,

        duration_days: finalPayload.apply.days,
        ...
        <section style={S.selectedContent}>
          ...
          <div style={S.selectedTop}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div style={S.selectedKicker}>Foco escolhido</div>
