...
export default function AdminArea() {
  ...
  const [justAuthorizedStudentId, setJustAuthorizedStudentId] = useState("");
  ...
  const authorizeStudent = async () => {
    ...
    try {
      ...
      setFilter("all");
      setJustAuthorizedStudentId(selectedStudent.id);
      setReloadKey((current) => current + 1);
                ...
                <div className="admin-training-actions">
                  ...
                  <button
                    ...
                    className={[
                      ...
                      "is-complete-action",
                      !selectedStudent.hasActiveWorkout ||
                      justAuthorizedStudentId === selectedStudent.id
                        ? "is-build-attention"
                        : "",
                    ]
                      .filter(Boolean)
