...
export default function Login() {
  ...
  useEffect(() => {
    ...
    const id = "fitdeal-login-micro-v5";
  ...
  async function handleForgotPassword() {
    ...
    try {
      ...
      showMessage("Enviamos um link de recuperação para seu email.");
    ...
    <div className="container page fadeUp" style={styles.page}>
      ...
      <div style={styles.auxRow}>
        ...
        <button
          ...
          onClick={isSignup ? () => nav("/comofunciona") : handleForgotPassword}

          disabled={loadingReset}

        >

          {isSignup ? "Como funciona?" : loadingReset ? "Enviando..." : "Esqueci a senha"}
      ...
      <div style={styles.footerRow}>
        ...
        <button type="button" className="tapSoft" style={styles.footerLink} onClick={() => nav("/suporte")}>
        ...
        <button type="button" className="tapSoft" style={styles.footerLink} onClick={() => nav("/politicas")}>
