...
export default function AdminWorkoutBuilder() {
  ...
  const publish = async () => {
    ...
    try {
      ...
      window.setTimeout(() => navigate("/area-accqua"), 900);
    } catch (error) {
      setToast(
  ...
  return (
    <div className="admin-builder-screen">
      ...
      <main className="admin-builder-shell">
        ...
        <section className="admin-builder-program-card">
        ...
        <section className="admin-builder-routines">
              ...
              {activeRoutine.exercises.map((exercise, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span className="admin-builder-exercise-order">
                        {index + 1}
                      </span>
        ...
        <section className="admin-builder-library">
          <header>
            <div>
