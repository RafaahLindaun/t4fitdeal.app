      ...
      <style>{`
        * {
        ...
        .primary-button {
          ...
          padding: 0 18px;
          border-radius: 18px;
          background: linear-gradient(180deg, rgba(255,106,0,1) 0%, rgba(255,152,64,1) 100%);
          color: #111;
          font-size: 15px;
          font-weight: 800;
        ...
        .timeline-bubble.done {
          background: linear-gradient(180deg, rgba(255,196,160,0.96) 0%, rgba(255,106,0,0.96) 100%);
          border-color: rgba(255,168,110,0.30);
          box-shadow:
            0 0 0 6px rgba(255,168,110,0.06),
            0 10px 20px rgba(255,106,0,0.16);
        }
        ...
        .cardio-ring-svg {
          filter: drop-shadow(0 10px 24px rgba(255,106,0,0.12));
          max-width: 100%;
          height: auto;
        }
