...
// - página com “cards” + “bottom sheet” (detalhes) sem libs
...
function buildDoseCards({ id, weightKg, goal, level }) {
  ...
  // Helpers por suplemento (retorna “dose sugerida” em string e detalhes)
  const protein = () => {
    // faixa comum para força/hipertrofia (g/kg/dia)
    let low = 1.6;
    let high = 2.2;
    if (goal === "saude") {
      low = 1.2;
    ...
    // dose por refeição (g/kg por refeição) – prático e elegante
  ...
  const creatine = () => {
    // manutenção típica: 3–5 g/dia OU ~0.1 g/kg/dia
    const maintA = 3;
    const maintB = 5;
    const maintKg = w * 0.1;

    // loading opcional: 0.3 g/kg/d por 5–7 dias
  ...
  const caffeine = () => {
    // 3–6 mg/kg pré-treino (30–60 min)
    const low = w * 3;
    const mid = w * 4.5;
    const high = w * 6;

    // suaviza para iniciante e saúde
    ...
    return {
      ...
      details: [
        { k: "Objetivo", v: "Atenção, percepção de esforço, desempenho (principalmente endurance/HIIT)." },
  ...
  const betaAlanine = () => {
    // 3.2–6.4 g/dia (dividido), por semanas
    const low = 3.2;
    const high = 6.4;
  ...
  const bicarbonate = () => {
    // 0.2–0.3 g/kg pré (60–180 min), GI é o limitante
    const low = w * 0.2;
    const high = w * 0.3;

    // sugestão “conservadora” para minimizar GI
    const sug = w * 0.2;
    ...
    return {
      ...
      timing: [
        { t: "Pré-treino", v: "60–180 min antes (teste o timing ideal)." },
      ],
      cautions: [
  ...
  const electrolytes = () => {
    // mais “lógico” por contexto do que por kg: foco em treino longo/suor
  ...
  const omega3 = () => {
    return {
      ...
      timing: [
        { t: "Com almoço/janta", v: "Rotina simples." },
      ],
      cautions: [
...
const CATALOG = [
  {
    id: "protein",
    group: "base",
    name: "Proteína (Whey/Caseína)",
    tag: "Evidência forte",
    accent: "soft",
    what: "Praticidade para bater proteína diária.",
  },
  {
    id: "creatine",
    group: "base",
    ...
    tag: "Evidência forte",
    accent: "orange",
    what: "Força, potência e volume de treino.",
  },

  {
    ...
    tag: "Evidência forte",
    accent: "soft",
    what: "Energia, foco e desempenho (dose por kg).",
  },
  {
    id: "beta_alanine",
    group: "performance",
    ...
    tag: "Boa evidência",
    accent: "soft",
    what: "Ajuda em esforços intensos repetidos (acúmulo).",
  },
  {
    id: "bicarb",
    group: "performance",
    ...
    tag: "Boa evidência",
    accent: "soft",
    what: "Buffer; útil em treinos muito densos (GI limita).",
  },

  {
    ...
    group: "recovery",
    name: "Eletrólitos",
    tag: "Contexto-dependente",
    accent: "soft",
    what: "Treinos longos/calor/suor: hidratação inteligente.",
  },
  {
    id: "omega3",
    group: "health",
    ...
    tag: "Suporte geral",
    accent: "soft",
    what: "Saúde cardiovascular; possível suporte à recuperação.",
  },
  {
    id: "vitamin_d",
    group: "health",
    name: "Vitamina D",
    tag: "Somente se necessário",
    accent: "soft",
    what: "Melhor com exame e orientação.",
  },
  {
    id: "magnesium",
    group: "health",
    ...
    tag: "Somente se necessário",
    accent: "soft",
    what: "Pode ajudar se ingestão baixa; forma importa.",
  },
];
...
export default function Suplementacao() {
  ...
  // Se você quiser manter paywall aqui também:
  ...
  // Recomendação leve (não agressiva) — “meu stack sugerido”
  ...
  if (!paid) {
    return (
      <div style={S.page}>
        <div style={S.head}>
          <button style={S.back} onClick={() => nav("/nutricao")} aria-label="Voltar">
            ←
          </button>
          ...
          <button style={S.pillBtn} onClick={() => nav("/planos")}>
            Ver planos
          </button>
        </div>
        ...
        <div style={S.lockCard}>
          ...
          <button style={S.lockBtn} onClick={() => nav("/planos")} className="tap">
  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.head}>
        ...
        <button style={S.pillBtn} onClick={() => nav("/dashboard")}>
          Dashboard
        </button>
      </div>
      ...
      {/* SAFE SPACE bottom menu */}
      <div style={{ height: 150 }} />

      {/* BOTTOM SHEET */}
      {openId && (
        <div style={{ ...S.sheetOverlay, ...(sheetOn ? S.overlayOn : S.overlayOff) }} onClick={closeSheet}>
          <div
          ...
          >
            ...
            <div style={S.sheetCtas}>
              ...
              <button style={S.ghostBtn} className="tap" onClick={() => nav("/nutricao")} type="button">
                Voltar à Nutrição
              </button>
            </div>
            ...
            <div style={S.sheetSection}>
              ...
              <div style={S.qa}>
                ...
                <div style={S.qaText}>
                  ...
                  Evite “blends” misteriosos e doses secretas.
                </div>
              </div>
            </div>
...
const S = {
  ...
  cardOn: {
    boxShadow: "0 18px 60px rgba(255,106,0,.14)",
    borderTop: "1px solid rgba(255,255,255,.70)",
  },
  ...
  sheetCtas: { padding: "0 14px 14px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 },
  primaryBtn: {
    padding: 14,
    borderRadius: 18,
    border: "none",
