...
requireMatch("156/version", "package.json", /"version":\s*"1\.5\.6"/, "package não está em 1.5.6");
requireMatch("156/contracts", "package.json", /verify-visual-contracts-1\.5\.6\.mjs/, "npm não executa contratos 1.5.6");
requireMatch("156/css-last", "scr/main.tsx", /build-1\.5\.5\.css";\s*\nimport "\.\/styles\/build-1\.5\.6\.css";/, "camada 1.5.6 não está no fim da cascata");

// Staff layout: sidebar independente + scroll compartilhado.
...
// Ranking 1.5.6: um ponto por data com lastro real.
...
// Cardio: uma fonte para dia/mês e Dieta consumindo a RPC.
...
// Recipe AI: arquivo oficial XLSX, validação antes do parse e erro recuperável.
...
// Montador: preserve tudo da 1.5.5 e devolva scroll ao centro.
