...
// SQL + segurança de mensagens Staff.
...
// Flicker de avatar: URL assinada estável e deduplicação de requests.
...
// Reservas: aluno vê somente as ativas, Staff continua com histórico via accqua_is_staff().
...
// Contraste, layout Staff e biblioteca.
...
// Loja: imagem reta, selo ancorado e Reservar visível em qualquer breakpoint.
...
// Montar Treino: preservar a arquitetura 1.5.0 que já implementa P1–P5.
...
requireMatch("154/contracts-script", "package.json", /verify-visual-contracts-1\.5\.4\.mjs/, "npm ainda executa contratos antigos");
